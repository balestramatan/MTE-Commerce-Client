  ...
  return (
    <>
      ...
      <div className={collectionsStyle.CollectionSortContainer}>
        ...
        <Dropdown placeholder='מיון לפי' options={['מחיר: מהנמוך לגבוה', 'מחיר: מהגבוה לנמוך', 'תאריך: מהחדש לישן']} onClick={() => {}} />
      </div>
        ...
        <div className={collectionsStyle.leftColumnContainer}>
          ...
          {products.length !== 0 &&
            products.map((product, i) => {
              return (
                <div key={i} className={collectionsStyle.collectionMiniCardContainer}>
